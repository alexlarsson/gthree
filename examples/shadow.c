...
init_scene (void)
{
  ...
  gthree_mesh_phong_material_set_color (ball_material, red ());
  ...
  gthree_mesh_phong_material_set_color (cube_material, green ());

  cube_geometry = gthree_geometry_new_box (50, 50, 50, 1, 1, 1);
  ...
  directional_light = gthree_directional_light_new (blue (), 1.0);
